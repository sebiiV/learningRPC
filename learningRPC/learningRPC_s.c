...
extern const MIDL_SERVER_INFO learningRPC_ServerInfo;

extern const RPC_DISPATCH_TABLE learningRPC_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE learningRPC___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xd4866451,0xc006,0x4680,{0xa2,0xa7,0xa2,0x6e,0x69,0xc6,0xd0,0xaa}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&learningRPC_v1_0_DispatchTable,
    0,
    0,
    0,
    &learningRPC_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE learningRPC_v1_0_s_ifspec = (RPC_IF_HANDLE)& learningRPC___RpcServerInterface;
...
static const MIDL_STUB_DESC learningRPC_StubDesc = 
    {
    (void *)& learningRPC___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION learningRPC_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE learningRPC_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)learningRPC_table
    };

static const SERVER_ROUTINE learningRPC_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Echo,
    (SERVER_ROUTINE)Shutdown
    };

static const MIDL_SERVER_INFO learningRPC_ServerInfo = 
    {
    &learningRPC_StubDesc,
    learningRPC_ServerRoutineTable,
    learningRPC__MIDL_ProcFormatString.Format,
    learningRPC_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
